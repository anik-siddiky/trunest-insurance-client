...
const Footer = () => {
    return (
        <footer className="border-t divide-y">
            <div className="max-w-7xl w-full mx-auto px-4 lg:px-0 flex flex-col justify-between py-10 space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        <div className="flex items-center justify-center">
                            <img className="w-8 md:w-10 lg:w-12" src={logo} alt="" />
                            <p className="font-bold mt-2 -ml-3.5 lg:mt-2 lg:-ml-5 text-2xl md:text-3xl lg:text-4xl">ruNest</p>
                        </div>
                    </a>
                </div>
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-start space-x-3">
                            {/* Facebook */}
                            <a href="https://www.facebook.com/" target='_blank' title="Facebook" className="flex items-center p-1">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                                    <path d="M32 16c0-8.839-7.167-16-16-16-8.839 0-16 7.161-16 16 0 7.984 5.849 14.604 13.5 15.803v-11.177h-4.063v-4.625h4.063v-3.527c0-4.009 2.385-6.223 6.041-6.223 1.751 0 3.584 0.312 3.584 0.312v3.937h-2.021c-1.984 0-2.604 1.235-2.604 2.5v3h4.437l-0.713 4.625h-3.724v11.177c7.645-1.199 13.5-7.819 13.5-15.803z"></path>
                                </svg>
                            </a>
                            {/* Twitter */}
                            <a href="https://www.x.com/" target='_blank' title="Twitter" className="flex items-center p-1">
                            ...
                            {/* Instagram */}
                            <a href="https://www.instagram.com/" target='_blank' title="Instagram" className="flex items-center p-1">
            ...
            <div className="py-6 text-sm text-center dark:text-gray-600">
                © 1968 TruNest Insurance. All rights reserved.
            </div>
        </footer>
    );
};
