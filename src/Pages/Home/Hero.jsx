    ...
    return (
        <section className="relative h-[60vh] flex items-center justify-center text-white overflow-hidden">
            <div className="absolute inset-0 z-0">
                <Carousel autoPlay infiniteLoop showThumbs={false} showStatus={false} showIndicators={false} showArrows={false} interval={5000} transitionTime={1000} axis="horizontal" swipeable={false} emulateTouch={false} stopOnHover={false}>
            ...
            <div className="relative z-10 container mx-auto flex flex-col items-center justify-center px-4 text-center md:px-10 lg:px-32 xl:max-w-3xl">
                ...
                <div className="flex flex-wrap justify-center">
                    <Link to="/all-policies">
                        <button className="hover:scale-105 lg:px-8 px-4 lg:py-3 py-2 m-2 text-lg bg-primary text-white rounded transition transform active:scale-95 shadow-sm cursor-pointer">
                            Get a Free Quote
                        </button>
                    </Link>
                </div>
